...
{   
    ...
    // Parameter gerakan
    const double BASE_FORWARD = 80;  // kecepatan dasar maju
    const double TURN_ADJUST = 5;     // perintah putar minimum (tapi akan dikoreksi)
    ...
    double firePower = (targetDistance < 150) ? 3 : 1;
